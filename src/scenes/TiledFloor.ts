...
export class TiledFloor {
  ...
  constructor(private readonly scene: Phaser.Scene, private readonly key: string, private readonly rect: FloorRect,
    private readonly origin: { x: number; y: number }, private readonly depth: number, private readonly alpha: number) {}
